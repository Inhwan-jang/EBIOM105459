%% Code for Fig. 4E : Run Fig4E_aic_liquid.m before this
...
ligand_intercept=min(x_data);
ligand_slope=(max(x_data)-min(x_data))/10;
for row_i=1:nrow
    for col_i=1:5
        temp_max=10;
        ...
        if temp_val==1
            ...
            temp_val=coef_list(b(row_i),16)*coef_list(b(row_i),col_i)*temp_max.^2./(temp_max.^2+coef_list(b(row_i),6)^2);
...
set(gca,'xcolor',[228,41,28]/255)
set(gca,'ycolor',[228,41,28]/255)
